...
import { Calculator, FileText, Heart, Stethoscope, Users, Clock, Star, ChevronRight, Brain } from 'lucide-react';
...
const EMTBNavigation: React.FC = () => {
  ...
  const quickStats = [
    ...
    { label: 'Flashcards', value: '24', icon: Brain, color: 'text-indigo-600' }
  ];
