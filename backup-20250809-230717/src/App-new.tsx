...
const moduleStructure = [
  ...
  {
    id: 6,
    title: "Shock Recognition & Response & BLS",
    description: "Shock Recognition & Response recognition and basic life support",
    color: "yellow",
    icon: Zap,
    chapters: [
...
**Comprehensive Patient Assessment**: Using knowledge of the body and diseases to figure out what is wrong with the patient and find life-threatening issues.

**Treatment**: Identifying patient care needs and prioritizing them, like helping with breathing, stopping Bleeding Management Techniques, or assisting childbirth. EMTs also learn to help patients in emotional distress.
...
- Assumes responsibility for Comprehensive Patient Assessment, care, packaging, and transport to the emergency department
...
const medicationsDatabase = [
  ...
  },
  {
    ...
    contraindications: ["Allergy to aspirin", "Active GI Bleeding Management Techniques", "Severe asthma", "Children under 16 (Reye's syndrome)"],
    dosing: "162-325mg PO (chewable preferred), chewed and swallowed",
    routes: ["Oral (chewable tablets preferred)"],
    sideEffects: ["GI irritation", "Bleeding Management Techniques", "Tinnitus", "Allergic reactions"],
    monitoring: ["Pain level", "Signs of Bleeding Management Techniques", "Allergic reactions", "Vital signs"],
...
**Contraindications:** Allergy, GI Bleeding Management Techniques, severe asthma
...
🩸 **Trauma:** Bleeding Management Techniques control, spinal immobilization
